...
def predict():
    try:
        ...
        if probability > 70:
            return render_template('high_risk.html', probability=probability, graph_url=graph_url)
        elif 40 < probability <= 70:
            return render_template('moderate_risk.html', probability=probability, graph_url=graph_url)
        else:
            return render_template('low_risk.html', probability=probability, graph_url=graph_url)
